...
A merge to `main` that passes unit tests and section 17 QA commits the version
pin, tags the release, publishes `ghcr.io/dev-kryptic/kryptic-operator`, and
opens a GitHub Release. After the first image lands, make that GHCR package
public or cluster pulls will 401.
